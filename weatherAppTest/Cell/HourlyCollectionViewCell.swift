...
class HourlyCollectionViewCell: UICollectionViewCell {
        ...
        func configure(with item: WeatherInfo) {
            ...
            tempSymbol.loadImageFromUrl(urlString: "http://openweathermap.org/img/wn/\(item.icon)@2x.png", placeholder: UIImage(systemName: "star.fill"))
            tempLabel.text = String(item.temp.kelvinToCelsiusConverter()) + " °C"
        }
    }
